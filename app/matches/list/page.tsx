                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {!match.is_online && match.last_active && (
                          <span className="text-[14px] text-gray-400 font-medium">
                            Online cách đây: {formatTime(match.last_active)}
                          </span>
                        )}
                      </div>
                      ...
                      {match.hobbies && match.hobbies.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          {match.hobbies.slice(0, 3).map((hobby, idx) => (
                            <span
                              key={idx}
                              className="text-[10px] px-2 py-0.5 bg-pink-50 dark:bg-pink-900/30 text-pink-600 dark:text-pink-300 rounded-full border border-pink-100 dark:border-pink-800"
                            >
